 ...
 *
 * Fill in the values below after running `amplify init && amplify add auth && amplify push`, or:
 *   - User Pool ID + App Client ID: AWS Console → Cognito → User Pools → your pool → App Integration
 *   - Identity Pool ID: AWS Console → Cognito → Identity Pools → your pool
 *
