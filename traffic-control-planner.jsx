                  ...
                  {ROAD_TYPES.map((rt) => (
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontSize: 9, color: COLORS.textDim }}>{rt.lanes} lanes • {rt.width}px width</div>
                      </div>
                ...
                {[...objects].reverse().map((obj) => (
                  ...
                  >
                    <span style={{ fontSize: 12 }}>
                      {obj.type === "road" ? "━" : obj.type === "sign" ? "⬡" : obj.type === "device" ? "▲" : obj.type === "zone" ? "▨" : obj.type === "arrow" ? "→" : obj.type === "text" ? "T" : "📏"}
                    </span>
                    <span>
